...
@section('content')
    ...
    <div>
        ...
        また、確認はしておりますが誤字脱字等がある場合はお手数ですが、Twitterにてご報告ください。</a>
    </div>
    ...
    <div>
        <a>著作権は、開発元であるQualiArts様にすべて帰属します。<br>
        本サイトは予告なく閉鎖する可能性があります。予めご了承ください。<br>
        本サイトは、Google Chromeによる表示を推奨しております。<br>
        スマホだと正常に表示できない可能性があります。ご了承ください。<br>
        サイトの利用により、損害や不具合等が利用者に対し発生しても、管理人は一切責任を負いかねます。申し訳ありませんが、ご利用は利用者本人の責任でお願いします。</a>
    </div>
